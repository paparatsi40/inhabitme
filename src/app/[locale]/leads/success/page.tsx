...
function LeadSuccessPageContent() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-green-500 to-green-600 p-8 text-white text-center">
          ...
          <p className="text-green-100">Ya puedes contactar directamente al anfitrión</p>
        </div>
        ...
        <div className="p-8">
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3 p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
              <span className="flex-1 font-mono text-lg text-blue-900 break-all">{hostEmail}</span>
              <Button onClick={copyEmail} variant="outline" size="sm" className="flex-shrink-0">
                {copied ? (
                  <>
          ...
          <div className="mb-8 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            ...
            <ol className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span><strong>Envía un email al anfitrión</strong> presentándote brevemente y mencionando que vienes de inhabitme</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span><strong>Menciona tus fechas</strong> de estancia y cualquier pregunta específica sobre la propiedad</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span><strong>Coordina una visita</strong> (virtual o presencial) y detalles del contrato directamente con el anfitrión</span>
              </li>
            </ol>
          </div>

          <details className="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <summary className="cursor-pointer font-semibold text-gray-900 hover:text-blue-600">💡 Ver plantilla de email sugerida</summary>
            <div className="mt-4 p-4 bg-white rounded border border-gray-200 text-sm text-gray-700 font-mono">
              <p className="mb-2">Hola,</p>
              <p className="mb-2">Me interesa {propertyTitle}. Vi tu propiedad en inhabitme y me gustaría saber más detalles.</p>
              <p className="mb-2">Estoy buscando alojamiento para [X meses] a partir de [fecha]. Soy [profesión/estudiante] y trabajo/estudio remotamente.</p>
              <p className="mb-2">¿Estaría disponible para una visita [virtual/presencial]?</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href={`/properties/${propertyId}`} className="flex-1">
              <Button variant="outline" className="w-full">Ver propiedad de nuevo</Button>
            </Link>
