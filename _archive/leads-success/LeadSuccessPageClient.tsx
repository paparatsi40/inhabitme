...
export default function LeadSuccessPageClient() {
    ...
    const verifyPayment = async () => {
      try {
        const response = await fetch(
          `/api/leads/verify-payment?session_id=${sessionId}&property_id=${propertyId}`
        )
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            {error || 'No se pudo obtener la información del anfitrión'}
          </p>
          <Link href="/search">
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-8 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            ...
            <ol className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Envía un email al anfitrión</strong> presentándote
                  brevemente y mencionando que vienes de inhabitme
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-white text-sm font-bold flex-shrink-0">
                ...
                <span>
                  <strong>Menciona tus fechas</strong> de estancia y cualquier
                  pregunta específica sobre la propiedad
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-white text-sm font-bold flex-shrink-0">
                ...
                <span>
                  <strong>Coordina una visita</strong> (virtual o presencial) y
                  detalles del contrato directamente con el anfitrión
                </span>
              </li>
            </ol>
          </div>
          ...
          <details className="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="mt-4 p-4 bg-white rounded border border-gray-200 text-sm text-gray-700 font-mono">
              ...
              <p className="mb-2">
                Me interesa {propertyTitle}. Vi tu propiedad en inhabitme y me
                gustaría saber más detalles.
              </p>
              <p className="mb-2">
                Estoy buscando alojamiento para [X meses] a partir de [fecha].
                Soy [profesión/estudiante] y trabajo/estudio remotamente.
              </p>
              <p className="mb-2">
        ...
        <div className="px-8 py-6 bg-gray-50 border-t text-center text-sm text-gray-600">
          <p>
            <strong className="text-gray-900">Nota:</strong> inhabitme no
            participa en la transacción final. El contrato y pago del alquiler
            se negocian directamente entre tú y el anfitrión.
          </p>
        </div>
      </div>
    </div>
